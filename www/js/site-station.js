$(document).on( "pageinit", "#stationPage", function() {
    ...
    LoadStorageStuff(function() {
        var stationSign = getParameterByName('sign');
        //console.log('sign', stationSign);
        GetStationInfo(stationSign);
...
function ShowType(ankomst) {
  var stationSign = getParameterByName('sign');
  var u = 'station.html?sign=' + stationSign;
...
function GetStationInfo(sign) {
    //$('#stationName').html(getStationNameBySign(sign));
    
    var activityType = getParameterByName('type');
    
    if (activityType == "") {
      activityType = "Avgang";
      //$('#changeTypeButton').text('Ankommande');
    } else {
      activityType = "Ankomst";
      $('#changeTypeButton').text('Avgående');
      $('#changeTypeButton').attr("href", "JavaScript:ShowType('');");
    }
    
    // Try to get station messages
    GetTrainMessage(sign);
...
function renderTrainAnnouncement(announcement) {
    ...
    var activityTypeString = 'Avgående';
    
    if (activityType != "") {
      activityTypeString = 'Ankommande';
    }

    var htmlResult = '';

    htmlResult = htmlResult + "<li data-role=\"list-divider\">" + getStationNameBySign(stationSign) + " - " + activityTypeString + "</li>";
